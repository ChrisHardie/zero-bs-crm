	...
	<?php
		...
		<div class='wrapper'>
				...
				<div class='alert alert-info'>
					...
					<?php ##WLREMOVE ?>
					<br />Learn more about the client portal <a style="color:orange;font-size:18px;" href="https://zerobscrm.com/kb/knowledge-base/how-does-the-client-portal-work/" target="_blank">here</a>
					<?php ##/WLREMOVE ?>
				</div>
