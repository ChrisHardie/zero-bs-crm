            ...
            // Following unpacking was genericified DAL3+ 
                ...
                if (is_array($addrCustomFields) && count($addrCustomFields) > 0){
                    ...
                    foreach ($addrCustomFields as $fieldKey => $field){
                        ...
                        //echo 'setting to '.$fieldKey.'!'; 
                        //Weirdly, here, the key is stored in ind 1? Not sure why, but this wasn't here correctly
                        // This doesn't work either, lol:
                        //$correctFieldKey = $fieldKey; if (isset($field[1])) $correctFieldKey = $field[1];
                        // this does...
