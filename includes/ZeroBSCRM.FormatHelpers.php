   		...
   		switch ($type){
   			...
   			case ZBS_TYPE_CONTACT:
				...
				$html = '<span class="ui navigation-quick-links">';
		   		...
		   		$html .= '<a style="margin-right:6px;" href="' . zbsLink($zbs->slugs["managecontacts"]) .'" class="ui button mini inverted basic" id="back-to-list">'. __("Back to List", "zero-bs-crm") . '</a>';
   			...
   			case ZBS_TYPE_COMPANY:
		   		...
		   		$html .= '<a style="margin-right:6px;" href="' . zbsLink($zbs->slugs["managecompanies"]) .'" class="ui button mini inverted basic" id="back-to-list">'. __("Back to List", "zero-bs-crm") . '</a>';
	        ...
	        switch ($fieldVal[0]){
	            ...
	            case 'text':
	                ...
	                <td>
	                	<div class="zbs-text-input <?php echo $fieldKey; ?>">
	                    	...
	                    	<input type="text" name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control widetext zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" value="<?php if ($value !== -99) echo esc_textarea($value); else echo $default; ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>" />
                ...
                case 'numberint':
	                ...
	                <td>
	                    ...
	                    <input style="width: 130px;display: inline-block;" type="text" name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control intOnly zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" value="<?php if ($value !== -99) echo esc_textarea($value); else echo $default; ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>" />
	            ...
	            case 'date':
	            	...
	            	if ($zbs->isDAL3()) $datevalue = zeroBSCRM_date_i18n(-1,$datevalue);//zeroBSCRM_locale_utsToDate($value);

	                ?><tr class="wh-large"><th><label for="<?php echo $fieldKey; ?>"><?php _e($fieldVal[1],"zero-bs-crm"); ?>:</label></th>
	                <td>
	                    <input type="text" name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-date zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" value="<?php echo $datevalue; ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>" />
	                </td></tr><?php
	            ...
	            case 'datetime':
	            	...
	            	// if DAL3 we need to use translated dates here :)
	            	if ($zbs->isDAL3()) $datevalue = zeroBSCRM_date_i18n_plusTime(-1,$datevalue); //zeroBSCRM_locale_utsToDatetime($value);

	                ?><tr class="wh-large"><th><label for="<?php echo $fieldKey; ?>"><?php _e($fieldVal[1],"zero-bs-crm"); ?>:</label></th>
	                <td>

	                    <input type="text" name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-date-time zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" value="<?php echo esc_textarea($datevalue); ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>" />
	            ...
	            case 'select':
	                ...
	                ?><tr class="wh-large"><th><label for="<?php echo $fieldKey; ?>"><?php _e($fieldVal[1],"zero-bs-crm"); ?>:</label></th>
	                <td>
	                    <select name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-watch-input zbs-dc" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>">
	                        <?php
	            ...
	            case 'tel':
	                ...
	                <td class="zbs-tel-wrap">
	                    ...
	                    <input type="text" name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-tel zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" value="<?php if ($value !== -99) echo esc_textarea($value); else echo $default; ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>" />
	            ...
	            case 'email':
	                ...
	                <td>
	                	<div class="<?php echo $fieldKey; ?>">
	                    	...
	                    	<input type="text" name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-email zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" value="<?php if ($value !== -99) echo esc_textarea($value); else echo $default; ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>" />
	            ...
	            case 'textarea':
	                ...
	                ?><tr class="wh-large"><th><label for="<?php echo $fieldKey; ?>"><?php _e($fieldVal[1],"zero-bs-crm"); ?>:</label></th>
	                <td>
	                    <textarea name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-dc" placeholder="<?php if (isset($fieldVal[2])) echo __($fieldVal[2],'zero-bs-crm'); ?>" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>"><?php if ($value !== -99) echo zeroBSCRM_textExpose($value); else echo $default; ?></textarea>
	                </td></tr><?php
	            ...
	            case 'selectcountry':
	                ...
	                ?><tr class="wh-large"><th><label for="<?php echo $fieldKey; ?>"><?php _e($fieldVal[1],"zero-bs-crm"); ?>:</label></th>
	                <td>
	                    <select name="<?php echo $postPrefix; ?><?php echo $fieldKey; ?>" id="<?php echo $fieldKey; ?>" class="form-control zbs-dc" autocomplete="zbs-<?php echo time(); ?>-<?php echo $fieldKey; ?>">
	                        <?php
