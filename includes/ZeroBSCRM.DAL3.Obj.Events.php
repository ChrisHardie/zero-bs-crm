...
class zbsDAL_events extends zbsDAL_ObjectLayer {
            ...
            #} ============= PRE-QUERY ============
                ...
                if ($withCustomFields && !$onlyID){
                    ...
                    if (is_array($custFields)) foreach ($custFields as $cK => $cF){
                        ...
                        // add as subquery
                        $extraSelect .= ',(SELECT zbscf_objval FROM '.$ZBSCRM_t['customfields']." WHERE zbscf_objid = event.ID AND zbscf_objkey = %s AND zbscf_objtype = %d) '".$cK."'";
    ...
    private function tidy_event($obj=false,$withCustomFields=false){
            ...
            */
            ...
            $res['complete'] = $this->stripSlashes($obj->zbse_complete);
