...
function zbscrmJS_customFields_buildNonSelect(area,typestr,i){
    ...
    html += '<input type="hidden" name="wpzbscrm_cf_'  + area + i + '_t" id="wpzbscrm_cf_'  + area + i + '_t" value="' + typestr + '">';
...
function zbscrmJS_customFields_updateRow(ele){
	...
	// get type str
	var typestr = jQuery('select.zbscrm-customtype',ele).val(); if (typeof typestr == "undefined") typestr = 'text';
