        ...
        public function save_data( $quoteID, $quote ) {
            ...
            if (!defined('ZBS_OBJ_SAVED')){
                ...
                /* old way:
                    ...
                    # and customer
                    //$zbsCustomerInvoiceMeta['customer'] = -1; if (isset($_POST['zbsci_customer'])) $zbsCustomerInvoiceMeta['customer'] = (int)$_POST['zbsci_customer'];
                    #if ($zbsCustomerInvoiceMeta['customer'] !== -1) zeroBS_saveInvoiceToCustomer($post_id,$zbsCustomerInvoiceMeta['customer']);
                ...
                */
                    ...
                    */
                    ...
                    // send as attachments checkbox
                    if (isset($_POST['zbsc_sendattachments']) && !empty($_POST['zbsc_sendattachments'])) $quote['send_attachments'] = 1;
                                            ...
                                            if (zeroBSCRM_isExtensionInstalled('pdfinv')){
                                                ...
                                                jQuery(document).ready(function(){
                                                    ...
                                                    var formHTML = '<form target="_blank" method="post" id="zbs_quote_download_pdf_form" action="">';
                                                        ...
                                                        formHTML += '<input type="hidden" name="zbs_quote_id" value="<?php echo $quoteID; ?>" />';
                                                        formHTML += '<input type="hidden" name="zbs_quote_pdf_gen" value="<?php echo esc_attr( wp_create_nonce( 'zbs-quote-pdf-gen' ) ); ?>" />';
                                                        formHTML += '</form>';
   ...
   ====================================================== */
    ...
    class zeroBS__Metabox_QuoteFiles extends zeroBS__Metabox{
        ...
        public function html( $quote, $metabox ) {
                ...
                $zbsSendAttachments = -1; if (is_array($quote) && isset($quote['send_attachments'])) $zbsSendAttachments = $quote['send_attachments'];
