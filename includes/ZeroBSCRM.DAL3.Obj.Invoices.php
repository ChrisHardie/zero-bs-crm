...
class zbsDAL_invoices extends zbsDAL_ObjectLayer {
    ...
    protected $objectModel = array(
        ...
        */
        ...
        'send_attachments' => array('fieldname' => 'zbsi_send_attachments', 'format' => 'bool'),
            ...
            #} ============= PRE-QUERY ============
                ...
                if ($withCustomFields && !$onlyID){
                    ...
                    if (is_array($custFields)) foreach ($custFields as $cK => $cF){
                        ...
                        // add as subquery
                        $extraSelect .= ',(SELECT zbscf_objval FROM '.$ZBSCRM_t['customfields']." WHERE zbscf_objid = invoice.ID AND zbscf_objkey = %s AND zbscf_objtype = %d) '".$cK."'";
        ...
        #} ============= PRE-QUERY ============
            ...
            if ($withCustomFields){
                ...
                if (is_array($custFields)) foreach ($custFields as $cK => $cF){
                    ...
                    // add as subquery
                    $extraSelect .= ',(SELECT zbscf_objval FROM '.$ZBSCRM_t['customfields']." WHERE zbscf_objid = invoice.ID AND zbscf_objkey = %s AND zbscf_objtype = %d) ".$cKey;
                ...
                if (!isset($invoiceData['discount']) && $invoiceData['discount'] <= 0){
                    ...
                    if ($discountType == 'percentage'){
                        ...
                        foreach ($invoiceData['lineitems'] as $lineItem) { 
                            ...
                            $n['discount'] = round($n['net']*$discountPercentage,2);
