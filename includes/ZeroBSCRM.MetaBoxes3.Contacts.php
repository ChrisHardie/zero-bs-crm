   ...
   ====================================================== */
    ...
    class zeroBS__Metabox_Contact extends zeroBS__Metabox{ 
                            ...
                            if (isset($fieldV[0])) switch ($fieldV[0]){
                                ...
                                // ... via js
                                    ...
                                    <td><div class="zbs-text-input <?php echo $fieldK; ?>">
                                        <input type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control widetext zbs-dc" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>" />
                                    </div></td></tr><?php
                                ...
                                case 'price':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <?php echo zeroBSCRM_getCurrencyChr(); ?> <input style="width: 130px;display: inline-block;;" type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc numbersOnly" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>" />
                                    </td></tr><?php
                                ...
                                case 'numberfloat':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <input style="width: 130px;display: inline-block;;" type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc numbersOnly" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>" />
                                    </td></tr><?php
                                ...
                                case 'numberint':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <input style="width: 130px;display: inline-block;;" type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc intOnly" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>" />
                                    </td></tr><?php
                                ...
                                case 'date':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <input type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-date zbs-dc" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>" />
                                    </td></tr><?php
                                ...
                                case 'select':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <select name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-watch-input zbs-dc" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>">
                                            <?php
                                ...
                                case 'tel':
                                    ...
                                    <td class="zbs-tel-wrap">
                                        <input type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc zbs-tel" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>" />
                                ...
                                // removed from email for now zbs-text-input
                                    ...
                                    <td><div class="<?php echo $fieldK; ?>">
                                        <input type="text" name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc zbs-email" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" value="<?php if (isset($zbsCustomer[$fieldK])) echo $zbsCustomer[$fieldK]; ?>" autocomplete="off" />
                                    </div></td></tr><?php
                                ...
                                case 'textarea':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <textarea name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc" placeholder="<?php if (isset($fieldV[2])) echo $fieldV[2]; ?>" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>"><?php if (isset($zbsCustomer[$fieldK])) echo zeroBSCRM_textExpose($zbsCustomer[$fieldK]); ?></textarea>
                                    </td></tr><?php
                                ...
                                case 'selectcountry':
                                    ...
                                    ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                                    <td>
                                        <select name="zbsc_<?php echo $fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control zbs-dc" autocomplete="zbscontact-<?php echo time(); ?>-<?php echo $fieldK; ?>">
                                            <?php
            ...
            if (!defined('ZBS_C_SAVED')){
                ...
                if ($zbs->DBVER < 2){
                    ...
                    */
                    ...
                    // echo '<pre>'; print_r(array($contact_id,$dataArr)); echo '</pre>';
        ...
        public function post_save_data($objID,$obj){
            ...
            if ($this->newRecordNeedsRedir){
                ...
                if (!empty($zbsJustInsertedMetaboxID) && $zbsJustInsertedMetaboxID > 0){
                    ...
                    // redir
                    wp_redirect( zbsLink('edit',$zbsJustInsertedMetaboxID,'zerobs_customer') );
                    exit;
        ...
        public function updateMessage(){
            ...
            $msg = zeroBSCRM_UI2_messageHTML('info olive mini zbs-not-urgent',__('Contact Updated',"zero-bs-crm"),'','address book outline','contactUpdated');
        ...
        public function updateEmailDupeMessage($otherContactID=-1){
            ...
            $msg = zeroBSCRM_UI2_messageHTML('info orange mini',__('Contact Email could not be updated. (A contact already exists with this email address).',"zero-bs-crm").$viewHTML,'','address book outline','contactUpdated');
...
class zeroBS__Metabox_ContactActions extends zeroBS__Metabox{
    ...
    public function html( $contact, $metabox ) {
        ...
        jQuery(document).ready(function(){
            ...
            // action items
            jQuery('.zbs-contact-action').unbind('click').click(function(){
    ...
    public function html( $contact, $metabox ) {
        ...
        ?><script type="text/javascript">
            ...
            jQuery(document).ready(function(){
                ...
                jQuery('#zbs-customerportal-toggle').unbind("click").bind('click',function(e){
                ...
                // bind reset pw
                jQuery('#zbs-customerportal-resetpw').unbind("click").bind('click',function(e){
...
class zeroBS__Metabox_ContactSocial extends zeroBS__Metabox{
    ...
    public function html( $contact, $metabox ) {
        ...
        $zbsSocials = zeroBS_getCustomerSocialAccounts($contact['id']);
    ...
    public function html( $contact, $metabox ) {
        ...
        if (gettype($zbsCustomer) != "array"){
            ...
            ?><div id="zbs-aka-alias-input-wrap">
                <input type="text" class="zbs-aka-alias-input" placeholder="<?php _e('Add Alias.. e.g.','zerobscrm.com'); ?> mike2@domain.com" />
            ...
            jQuery(document).ready(function(){
                ...
                jQuery('#zbs-aka-alias-add').unbind('click').click(function(){

                    var v = jQuery.trim(jQuery('.zbs-aka-alias-input').val());
            ...
            function zeroBSJS_bindAKAMode(){
                ...
                // remoe aka
                jQuery('.zbs-aka-alias-remove').unbind('click').click(function(){
...
class zeroBS__Metabox_ContactCompany extends zeroBS__Metabox{
    ...
    public function html( $contact, $metabox ) {
        ...
        echo "<span>" . __('Type to Assign Company', "zero-bs-crm") . '</span>';

        #} Co Name Default
        $coName = ''; $coID = '';
        if ( 'contact' == $this->objType ){ # && $custType !== 'co' && 0 != count( get_post_templates() ) ) {
            $coID = -1; if (is_array($contact) && isset($contact['id'])) $coID = zeroBS_getCustomerCompanyID($contact['id']);//get_post_meta($post->ID,'zbs_company',true);
            if (!empty($coID)){
        ...
        function zbscrmjs_customer_changedCompany(newval){
            ...
            //  console.log("Company Changed!",newval);
...
class zeroBS__Metabox_Contact_Activity extends zeroBS__Metabox {
    ...
    public function __construct( $plugin_file ) {
        ...
        $this->metaboxTitle = __('Activity', 'zerobscrm');
