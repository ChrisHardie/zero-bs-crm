...
#} Filters (done in this branch as quick and asked for)
$login_title = __('Welcome to your Client Portal',"zero-bs-crm");
$login_intro = __("Please login to your Client Portal to be able to view your documents","zero-bs-crm");

$login_title = apply_filters('zbs_portal_login_title', $login_title);
$login_intro = apply_filters('zbs_portal_login_content', $login_title);

?>
<h2><?php echo $login_title;?></h2>
<p><?php  echo $login_intro;?></p>
